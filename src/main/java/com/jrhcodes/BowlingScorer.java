...
public class BowlingScorer {
    ...
    private static int bowlScore(char digit) {
        return (digit == '-') ? 0 : digit - '0';
    }

    private static char getBowl(String frame, int index) {
        return frame.charAt(index);
    }
    ...
    private static boolean isStrike(char bowl) {
        return bowl == 'X';
    }

    private static boolean isSpare(char bowl) {
        return bowl == '/';
    }
